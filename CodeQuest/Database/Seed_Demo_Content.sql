/*
    ...
    The prototype login validates the temporary demo password in application
    code, then links that session to this database row so admin-created content
    and support replies have the required dbo.User foreign key.
*/
...
BEGIN
    ...
    BEGIN
        ...
        INSERT INTO dbo.Tutorial(tutorial_title, materials, status, category)
        VALUES (N'HTML Document Structure', N'HTML documents start with a document type declaration. The document begins with <html> and the visible page content lives between <body> and </body>. Example:\n\n<!DOCTYPE html>\n<html>\n<head>\n  <title>My first page</title>\n</head>\n<body>\n  <h1>My First Heading</h1>\n  <p>My first paragraph.</p>\n</body>\n</html>\n\nThe <!DOCTYPE html> declaration must appear once at the top of the page and is not case sensitive.', N'Published', N'HTML');
